...
const Search = () => {
  ...
  const currentYear = `${today.getFullYear()}-${String(
    today.getMonth() + 1
  ...
  const fetchProducts = useCallback(() => {
    const { room, adults, kids, sort, checkInDate, checkOutDate } =
      debouncedFilters;
    dispatch(
      getProducts(city, room, adults, kids, sort, checkInDate, checkOutDate)
    );
